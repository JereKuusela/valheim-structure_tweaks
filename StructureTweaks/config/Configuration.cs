...
#nullable disable
  ...
  public static ConfigEntry<bool> configNoRespawnPointSuppression;
...
#nullable enable
  public static void Init(ConfigWrapper wrapper) {
    ...
    configNoSpawnPointSuppression = wrapper.Bind(section, "No spawn point suppression (one time)", true, "One time spawn points can't be suppressed with player base (even when configured to respawn).");
    configNoSpawnPointSuppression.SettingChanged += (s, e) => NoSuppression.Update();
    configNoRespawnPointSuppression = wrapper.Bind(section, "No spawn point suppression (respawning)", false, "Respawning spawn points can't be suppressed with player base (even when configured to one time).");
    configNoRespawnPointSuppression.SettingChanged += (s, e) => NoSuppression.Update();
